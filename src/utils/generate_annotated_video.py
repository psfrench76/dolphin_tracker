...
def main():
    ...
    parser.add_argument('--resize_ratio', default=1.0, type=float, help="Ratio by which to resize the frames (e.g., 0.5 for half size).")
    parser.add_argument('--gt', action='store_true', help="Label as ground truth video")
    args = parser.parse_args()

    generate_video(args.image_folder, args.bbox_file, args.output_folder, args.resize_ratio, args.gt)
